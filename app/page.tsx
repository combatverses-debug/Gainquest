...
const s: { [k: string]: React.CSSProperties } = {
  ...
  heroClass: { fontSize: 11, color: "#7a6d9b", marginBottom: 6 },
  ...
  xpLabel: { display: "flex", justifyContent: "space-between", fontSize: 10, color: "#7a6d9b", marginTop: 4 },
  ...
  statLbl: { fontSize: 9, color: "#7a6d9b", marginTop: 2, textTransform: "uppercase" as const, letterSpacing: "0.06em" },
  ...
  quickSub: { fontSize: 10, color: "#7a6d9b", marginTop: 2 },
  ...
  weekStatLbl: { fontSize: 10, color: "#7a6d9b", marginTop: 2 },
